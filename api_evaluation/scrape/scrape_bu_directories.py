#!/usr/bin/env python3
"""
Scrape faculty names from Boston University directory pages. Output: api_evaluation/inputs/bu_scraped.csv
"""
import csv
import time
...
OUTPUT_PATH = Path(__file__).resolve().parent.parent.parent / "api_evaluation" / "inputs" / "bu_scraped.csv"
...
DIRECTORIES: List[DirSpec] = [
    DirSpec("CAS", "https://www.bu.edu/cas/faculty/", "College of Arts and Sciences"),
    DirSpec("ENG", "https://www.bu.edu/eng/faculty/", "College of Engineering"),
    DirSpec("Questrom", "https://questrom.bu.edu/faculty/", "Questrom School of Business"),
    DirSpec("Law", "https://www.bu.edu/law/faculty/", "School of Law"),
    DirSpec("SPH", "https://www.bu.edu/sph/faculty/", "School of Public Health"),
    DirSpec("COM", "https://www.bu.edu/com/faculty/", "College of Communication"),
    DirSpec("Wheelock", "https://www.bu.edu/wheelock/faculty/", "Wheelock College of Education"),
]
