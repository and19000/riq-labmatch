#!/usr/bin/env python3
"""
Scrape faculty names from Tufts directory pages. Output: api_evaluation/inputs/tufts_scraped.csv
"""
import csv
import time
...
OUTPUT_PATH = Path(__file__).resolve().parent.parent.parent / "api_evaluation" / "inputs" / "tufts_scraped.csv"
...
DIRECTORIES: List[DirSpec] = [
    DirSpec("AS", "https://as.tufts.edu/faculty", "School of Arts and Sciences"),
    DirSpec("Engineering", "https://engineering.tufts.edu/people/faculty", "School of Engineering"),
    DirSpec("Nutrition", "https://nutrition.tufts.edu/people", "Friedman School of Nutrition"),
    DirSpec("Fletcher", "https://fletcher.tufts.edu/people/faculty", "The Fletcher School"),
    DirSpec("Dental", "https://dental.tufts.edu/about-us/faculty", "School of Dental Medicine"),
    DirSpec("Medicine", "https://medicine.tufts.edu/faculty", "School of Medicine"),
]
